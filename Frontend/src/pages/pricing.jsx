        ...
        <div className=" grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <ul role="list" className="space-y-5 my-7">
              <li className="flex items-center justify-center text-white text-xl">
                <span className="mr-2 text-white-500">•</span> Unlimited access
                to the GYM
              </li>
              <li className="flex items-center justify-center text-white text-xl">
              ...
              <li className="flex items-center justify-center text-white text-xl">
                <span className="mr-2 text-white-500">•</span> One year
                membership
              </li>
              <li className="flex items-center justify-center text-white text-xl">
                <span className="mr-2 text-white-500">•</span> 3 classes per
                week
              </li>
              <li className="flex items-center justify-center text-white text-xl">
          ...
          >
            ...
            <ul role="list" className="space-y-5 my-7">
              ...
              <li className="flex items-center justify-center text-white text-xl">
                <span className="mr-2 text-white-500">•</span> 5 classes per
                week
              </li>
              <li className="flex items-center justify-center text-white text-xl">
          ...
          >
            ...
            <ul role="list" className="space-y-5 my-7">
              ...
              <li className="flex items-center justify-center text-white text-xl">
                <span className="mr-2 text-white-500">•</span> Two year
                membership
              </li>
              <li className="flex items-center justify-center text-white text-xl">
                <span className="mr-2 text-white-500">•</span> 7 classes per
                week
              </li>
              <li className="flex items-center justify-center text-white text-xl">
